...
parser.add_argument('--fusion_type', type=str, default='global_weight', choices=['global_weight', 'global_rl', 'local_rl', 'local_weight', 'original'], help='the type of fusion used by the checkpoints being tested')
